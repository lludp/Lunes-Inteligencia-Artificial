...
public class PathPriorityQueue<TData>
{
    ...
    private readonly List<Tuple<TData, float>> data;
    private readonly Dictionary<TData, int> indexes;
    private readonly Func<float, float, bool> critery;
    ...
    public void Enqueue(TData item, float priority)
    {
        Enqueue(new Tuple<TData, float>(item, priority));
    }
    ...
    public TData Dequeue()
    {
        ...
        if (explorIndex == -1) return date.Item1;
